...
- [ ] `python3 -m aishield scan . --profile release --json` (record verdict and exit code)
- [ ] `git diff --check`
...
- [ ] The change does not claim that AI Shield or scanned software is safe, secure, or certified