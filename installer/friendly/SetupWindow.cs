    ...
    internal sealed class SetupWindow : Form
    {
        ...
        void Work(object sender, DoWorkEventArgs e)
        {
            ...
            if (requested == Operation.Enable)
            {
                ...
                e.Result = AccountPreferenceTransaction.Apply(request.Identity, true);
                return;
            }
            e.Result = found;
        }
        void Finished(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            else
            {
                ...
                installed = !absent;
                selectedIdentity = null; settingsDestination = null;
                ...
                if (found != null)
                {
                    ...
                    settingsDestination = Path.Combine(Plan().Profile, ".claude", "settings.json");
        ...
        void ShowFailure(Exception error)
        {
            ...
            missingSettings = true; selectedIdentity = null; settingsDestination = null;
            remainderRoot = null;
